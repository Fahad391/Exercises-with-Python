...
class Car_Tracker:
    ...
    def analyze(self):
        """Calculate statistics on unique brands using NumPy"""
        brands_array = self.data_frame["Brand"].to_numpy()
        unique_brands, counts = np.unique(brands_array, return_counts=True)
